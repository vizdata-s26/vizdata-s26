...
Techniques introduced early in the term will be essential for understanding later topics, so consistent practice is very important.
...
All students must adhere to the [Duke Community Standard (DCS)](https://studentaffairs.duke.edu/conduct/about-us/duke-community-standard): Duke University is a community dedicated to scholarship, leadership, and service and to the principles of honesty, fairness, and accountability.
...
-   **Attendance and participation** is required throughout the semester.
    Students who attend at least 80% of the lectures and participate regularly during lecture will receive full credit for this portion of their grade.
    Participation in labs as well as on Slack will also count towards this component.

-   **Quizzes**, due every other week (roughly), completed individually.
    Lowest quiz score is dropped.

    Reading quizzes will be linked from the [course schedule](https://vizdata.org).
    They always cover reading that is due since the previous quiz and up to and including the deadline for the given quiz.
    They're due by 10 am ET (beginning of class) on the indicated day on the [course schedule](https://vizdata.org).

-   **Homework assignments**, due every other week (roughly), completed individually.
...
| Project 1                      | 20%        |
| #TidyTuesday video + blog post | 10%        |
| Project 2                      | 30%        |
...
-   Homework assignments: GitHub repositories will be closed to contributions at the deadline.
    If you need to submit your work late, send a DM on Slack to the Head TA to reopen your repository.
...
-   Projects: The following three components contribute to your project score.
    ...
    -   Write up: GitHub repositories will be closed to contributions at the deadline.
        If you need to submit your work late, Slack/email me to reopen your repository.
...
If there are circumstances that prevent you from completing a lab or homework assignment by the stated due date, you may email or DM the Head TA before the deadline to waive the late penalty.
...
Regrade requests must be made within one week of when the assignment is returned, and must be typed up and submitted via email to the course Head TA. These will be considered if points were tallied incorrectly or if you feel your answer is correct but it was marked wrong.
