...
**New York state of ridges.** The goal of this exercise is to learn about a new type of plot (ridgeline plot) and to learn how to make it. 
...
Recreate the following visualization. Some notes:

-   This figure a colorblind-friendly color scale from ggthemes.
