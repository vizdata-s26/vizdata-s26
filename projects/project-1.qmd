...
-   Week 2 of project (week of February 2): Provide peer review of one other team's proposal in the form of issues in their GitHub repos. Start addressing the issues left on your team's project repo by closing them with explicit commits. Feel free to get started on your presentation as well.

-   Week 3 of project (week of February 9): Finish addressing the issues left on your team's project repo by closing them with explicit commits and submit your proposal for instructor review. Later in the week review feedback from me on your proposal and close any remaining issues. Work on your presentation in `presentation.qmd` and write-up in `index.qmd`.
...
-   Week 5 of project (week of February 23): Finalize your write-up, presentation, and your project website. Present in lab on the Thursday of this week.
...
Each of your projects will have a website that looks like <https://vizdata-s26.github.io/project-1> (to be posted). You are not expected to change the styling of the website, but if you want to, you'll need to edit the `_quarto.yml` file in your repo. Feel free to google your way around it or ask on the discussion forum / office hours!
