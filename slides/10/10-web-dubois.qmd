...
- Schedule update: HW 3 due date pushed to Thursday, 3/5 at 5 pm (right before spring break) to give you a bit more time + additional lab session to work on it.
...
::: {.column width="50%"}
!["Assessed Value of Household and Kitchen Furniture Owned by Georgia Negroes" showing the spiral technique](images/kitchen-furniture.png)
:::
:::
...
::: aside
View maps in the [Library of Congress collection](https://www.loc.gov/collections/african-american-photographs-1900-paris-exposition/?fa=subject:maps).
:::

## Unconventional bar variations {.smaller}
...
::: {.column width="50%"}
!["Illiteracy" showing the woven bar technique](images/illiteracy.png)
:::
:::
