...
-   Leah Johnson - Head TA + Lab 1 TA
-   Luxman Maheswaran - Lab 2 TA
-   Alexa Fahrer
:::
:::
...
-   Periodic quizzes on pseudo-random days in lecture and lab
-   Cover readings and/or lecture material
-   If you score at least 60& on quizzes, you will receive full credit for this component
...
::: task
Due during lab time on reading day?
:::
...
|:---------------------------|:-----------|:------|--------------------------------------------|
| Quizzes                    | Individual | 10%   | \~ Every other week                        |
| Homeworks                  | Individual | 30%   | \~ Every other week                        |
| Project 1                  | Team       | 25%   | \~ Week 6 + earlier interim deadlines      |
| Project 2                  | Team       | 35%   | \~ Finals week + earlier interim deadlines |
...
-   Project presentations and write-ups: Late submissions not accepted
...
-   Locally install or use the departmental server ([rstudio.stat.duke.edu](https://rstudio.stat.duke.edu))

-   Server requires Duke NetID login and VPN if off-campus
...
3.  Make sure you can locally install R + Positron and/or login in to the departmental server and initiate a Positron session

4.  Complete the *Getting to know you* survey on Canvas tomorrow (instead of going to lab)

5.  Complete the readings for next week
