...
Add this in an iframe https://www.instagram.com/reel/DWg7Fa9DqA8/?igsh=a3Fvc25ta2F6ejN2
...
```{r}
# do the same as above for turkiye, australia, and europe
...
```{r}
# calculate according to the "for japan" methodology described above
...
```{r}
# put together with left_join by year, and save as "inflation" dataset
...
inflation_long <- inflation |>
  ...
  mutate(
    ...
    country = fct_relevel(country, "Turkiye", "Japan", "Europe", "USA", "Australia")
  )
