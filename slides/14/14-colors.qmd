...
**Solution:** Use direct labeling instead of relying on color legends when you have many categories

## Too many colors example

![](https://clauswilke.com/dataviz/pitfalls_of_color_use_files/figure-html/popgrowth-US-rainbow-1.png)

::: aside
Figure from [Claus O. Wilke. Fundamentals of Data Visualization. O'Reilly, 2019.](https://clauswilke.com/dataviz)
:::

## Better: Direct labeling

![](https://clauswilke.com/dataviz/pitfalls_of_color_use_files/figure-html/popgrowth-US-labeling-1.png)
...
## Rainbow scale example

![](https://clauswilke.com/dataviz/pitfalls_of_color_use_files/figure-html/map-Texas-rainbow-1.png){width="85%"}

Notice how the rainbow creates artificial emphasis at certain thresholds

::: aside
Figure from [Claus O. Wilke. Fundamentals of Data Visualization. O'Reilly, 2019.](https://clauswilke.com/dataviz)
:::

## Better: Sequential scale

![](https://clauswilke.com/dataviz/pitfalls_of_color_use_files/figure-html/map-Texas-Carto-Mint-1.png){width="85%"}

Sequential scales show data more accurately without artificial banding
...
Diverging scales should progress **symmetrically** from the neutral center to both extremes
...
This ensures equal visual weight is given to positive and negative deviations
