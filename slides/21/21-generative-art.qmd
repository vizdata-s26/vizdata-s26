...
- Tomorrow in lab: Project 2 proposal peer review + improvement based on peer review

- Tomorrow at 1 pm: Submit preference for Project 2 presentation date -- watch for email/Canvas announcement for link to form, and make sure to discuss with your team and come to a consensus first!

- Friday: Project 2 propoposals due
...
::: task
- [Review dashboard layout components.]{style="color: gray;"}
- [Add values to valueboxes.]{style="color: gray;"}
- [Create cards automatically and manually.]{style="color: gray;"}
- **Add logo**.
:::
...
::: task
Go to `ae-15` and let's make some flowers!
:::
