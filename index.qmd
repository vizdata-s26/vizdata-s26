...
gs4_deauth()
d <- read_sheet(
  "https://docs.google.com/spreadsheets/d/1nsKtz4J942dQC35jS8jVMBNzwLA3241ThcLY1xL_aTg/edit?usp=sharing"
) |>
  select(!helper)
prepare_cutoff_date <- as.Date("2026-02-16")
```
...
d |>
  ...
  mutate(
    ...
    topic = if_else(
      (session %in% c("Lec", "Lab") & is.na(topic)),
      "_To be posted_",
      topic
    )
  ) |>
